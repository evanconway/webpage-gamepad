...
import { Move, arcadeStickHistoryMatchMove, move236PL, move236PM, move236PH, move214PL, move214PM, move214PH, move623PL, move623PM, move623PH, move421PH, move421PL, move421PM } from "../util/moves";
...
export const movesCheckSlice = createSlice({
    ...
    reducers: {
        addMove: (state, action: PayloadAction<Move>) => {
            ...
            state.moves.sort((a, b) => a.inputHistories[0].length - b.inputHistories[0].length);
        },
